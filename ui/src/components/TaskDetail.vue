...
<template>
  <section class="panel task-detail">
    ...
    <ProjectToolchain v-if="task.options.project_framework === 'flask'" :project="task.options.visual_project" :editable="editable" :checkpoint="task.status + ':' + workflow?.stage" />
